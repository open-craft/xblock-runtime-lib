...
VERSION = get_version('xblock_runtime_lib', '__init__.py')
...
setup(
    name='xblock-runtime-lib',
    version=VERSION,
    description="""Useful bits of code when implementing an XBlock runtime.""",
    long_description=README + '\n\n' + CHANGELOG,
    author='OpenCraft',
    author_email='help@opencraft.com',
    url='https://github.com/open-craft/xblock-runtime-lib',
    packages=[
        'xblock_runtime_lib',
    ],
