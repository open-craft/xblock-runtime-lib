...
With code from:
    ...
    https://github.com/openedx/edx-platform/blob/250c94d/openedx/core/djangoapps/xblock/runtime/serializer.py
"""
...
def override_export_fs(block):
    ...
    try:
        yield fs
    except Exception:  # lint-amnesty, pylint: disable=try-except-raise
        raise
    finally:
